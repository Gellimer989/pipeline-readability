...
def main():
    ...
    with open(BASE_PATH + '/../../data/dataset/metrics.csv', 'a+', encoding="utf8") as f:
        writer = csv.writer(f)
...
def init_csv():
    ...
    header = ['FileName', 'Loc', 'AvgAssignment', 'AvgBlankLines', 'AvgColon', 'AvgComment', 'AvgDash',
              ...
              'MaxOccurrencesEnv', 'MaxScriptLenght']
    with open(BASE_PATH + '/../../data/dataset/metrics.csv', 'w', encoding="utf8") as f:
        writer = csv.writer(f)
